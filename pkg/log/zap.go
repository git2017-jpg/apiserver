...
func getLoggerLevel(cfg *config.LogConfig) zapcore.Level {
...
func newLoggerWithCallerSkip(cfg *config.LogConfig, skip int) (Logger, error) {
...
func buildLogger(cfg *config.LogConfig, skip int) *zap.Logger {
...
func getAllCore(encoder zapcore.Encoder, cfg *config.LogConfig) zapcore.Core {
...
func getInfoCore(encoder zapcore.Encoder, cfg *config.LogConfig) zapcore.Core {
...
func getWarnCore(encoder zapcore.Encoder, cfg *config.LogConfig) (zapcore.Core, zap.Option) {
...
func getErrorCore(encoder zapcore.Encoder, cfg *config.LogConfig) (zapcore.Core, zap.Option) {
...
func getLogWriterWithTime(cfg *config.LogConfig, filename string) io.Writer {
